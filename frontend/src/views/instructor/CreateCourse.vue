    ...
    <div class="course-builder">
      ...
      <div class="steps-indicator">
        ...
        <div class="step" :class="{ active: currentStep === 2, completed: currentStep > 2 }">
          ...
          <div class="step-label">Add Lessons</div>
        </div>
        <div class="step-divider"></div>
      ...
      <div v-if="currentStep === 3" class="step-content card">
        ...
        <div class="form-actions">
          <button type="button" @click="prevStep" class="btn btn-secondary">← Back</button>
          <button type="button" @click="handleSubmit" class="btn btn-success" :disabled="loading">
...
async function handleSubmit() {
  ...
  try {
    ...
    if (isEdit.value) {
      ...
      const courseResponse = await courseService.createCourse(formData.value)
